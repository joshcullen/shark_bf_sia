...
# ggsave("Figures/Figure 5.pdf", width = 6, height = 8, units = "in", dpi = 600, device = cairo_pdf)
...
# ggsave("Figures/Figure 6.pdf", width = 12, height = 8, units = "in", dpi = 600, device = cairo_pdf)
